...
export default function LocalErrorFallback({ error, resetErrorBoundary }: FallbackProps) {
 ...
 return (
  <div role="alert" className="flex items-center justify-center text-center flex-col bg-gray-200 p-8 rounded-lg gap-6">
   ...
   <div className="flex gap-1">
    <Button variant={'outline'} onClick={resetErrorBoundary} size={'sm'} className={"hover:shadow-sm"}>
