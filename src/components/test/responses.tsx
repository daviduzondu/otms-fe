...
export default function Responses({ testDetails }: { testDetails: TestDetails }) {
 ...
 return (
  <>
   {isLoading ? <div className='flex w-full items-center justify-center text-gray-700 h-[60vh]'><Loader className='animate-spin mr-2' /> Loading submissions...</div> : isError ? <div className="flex items-center justify-center h-full text-red-500">{error.message}</div> : <div className="flex gap-4">
