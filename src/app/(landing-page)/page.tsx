import { BookA, ChartSpline, CircleMinus, Dice1, FileLock, FileQuestion, LucideDices, MonitorSmartphone, Notebook, Plane, Share, SquareFunction, StarHalf, Tags, Timer, Wallpaper, Webcam } from "lucide-react"
...
const featureSections: TFeatureSection[] = [
 ...
 {
  context: 'Deliver', title: 'Get that test anywhere, in perfect condition.', description: `You're always in control. Deliver tests, revoke access and more.`,
  cards: [{
 ...
 {
  context: 'Grade & Analyse', title: 'Automated grading for MCQs + Result analysis at your fingertips', description: `You're always in control. Deliver tests, revoke access and more.`,
  cards: [{
 ...
 {
  context: 'Secure', title: 'Top notch security like never before', description: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, vero?`,
  cards: [{
