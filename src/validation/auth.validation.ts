...
export const RegSchema = z.object({
 name: z.string({ required_error: "Name is required" }).min(4, { message: "Name must be longer than 4 characters" }).regex(/^[A-Za-z\s]+$/, { message: "Name must only contain English alphabets and spaces" }),
